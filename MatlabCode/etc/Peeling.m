...
data.spikes = zeros(1,1000); %%%%% by Xiaoqian, that's already the case in InitPeel()
data.numspikes = 0;          %%%%% by Xiaoqian, that's already the case in InitPeel()

data.peel = data.dff;        %%%%% by Xiaoqian, that's already the case in InitPeel()
